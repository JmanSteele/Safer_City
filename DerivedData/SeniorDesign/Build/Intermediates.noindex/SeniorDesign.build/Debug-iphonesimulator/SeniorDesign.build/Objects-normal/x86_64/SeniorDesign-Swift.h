...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SeniorDesign",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12SeniorDesign11AppDelegate")
...
SWIFT_CLASS("_TtC12SeniorDesign9MapScreen")
...
@interface MapScreen (SWIFT_EXTENSION(SeniorDesign)) <CLLocationManagerDelegate>
...
@interface MapScreen (SWIFT_EXTENSION(SeniorDesign)) <MKMapViewDelegate>
